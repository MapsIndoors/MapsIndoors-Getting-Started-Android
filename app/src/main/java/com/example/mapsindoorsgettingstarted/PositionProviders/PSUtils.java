...
public class PSUtils {
    ...
    public static void showNOGPSAlertDialogue(final Context context) {
        ...
        alertDialogBuilder.setTitle("Location Services are disabled");
        alertDialogBuilder.setMessage("Please turn on your phone GPS to determine your location");
        alertDialogBuilder.setPositiveButton("Settings", (dialogInterface, i) -> startGPSSettingsActivity(context));
    ...
    static void showNOGPSPermissionAlertDialogue(final Context context) {
        ...
        alertDialogBuilder.setTitle("Allow the app to access this devices location.");
        alertDialogBuilder.setMessage("The location is used to show your position on the map and for routing.");

        alertDialogBuilder.setPositiveButton("Settings", (dialogInterface, i) -> {
